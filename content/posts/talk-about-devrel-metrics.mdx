...
draft: false
hero: /images/posts/devrel-metrics.jpg
description: "Crunching numbers is hard. And OKRs suck. So that means we can forget about DevRel metrics, right? Well, chat about that now."
...
<Callout title="Moving Developer Relations Forward (6 Part Series)">
  <ul>
...
DevRel as a discipline is [basically 30 years old](/posts/the-foundations-of-devrel#begin-at-the-beginning), and yet there’s such a general resistance about measuring DevRel, either as a general discipline, or the individual program in the company. Why is that?
...
<XEmbed user="jonobacon" id="1363177613498458114" />
...
<blockquote>
  <p>
    <a
      href="https://web.archive.org/web/2023/https://twitter.com/jonobacon/status/976186666988769280"
      target="_blank"
      rel="noopener noreferrer"
    >
      Archived post by Jono Bacon on X (formerly Twitter) →
    </a>
  </p>
</blockquote>

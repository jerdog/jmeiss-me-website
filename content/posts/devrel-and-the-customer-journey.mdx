...
<figure>
  <img src="https://dev-to-uploads.s3.amazonaws.com/uploads/articles/qn6vlwdt01j6jgt21i6q.png" alt="Example customer journey map with awareness, consideration, and retention stages" />
...
<table style={{ width: "75%" }}>
  ...
  <tbody>
    <tr style={{ verticalAlign: "top" }}>
      <td>
        <ul>
          <li>Attended company meetup</li>
          <li>Conversation at a conference</li>
          <li>Entered raffle</li>
          <li>Visited booth</li>
          <li>Gave product feedback</li>
        </ul>
      </td>
      <td>
        <ul>
          ...
          <li>Workshop</li>
          <li>Blog post written</li>
          <li>Sample created</li>
          <li>Demo given at customer</li>
        </ul>
      </td>
    </tr>
  </tbody>
